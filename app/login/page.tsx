        ...
        <div className="flex">
          ...
          <div className="flex-1 lg:w-3/5 flex items-center justify-center p-8 relative z-10">
            <div className="w-full max-w-md">
              ...
              {error && (
                <div className={`mb-6 p-4 rounded-lg ${isRateLimited ? 'bg-blue-50 border border-blue-200' : 'bg-red-50 border border-red-200'}`}>
                  <div className="flex">
                    ...
                    <div className="ml-3 flex-1">
                      <p className={`text-sm ${isRateLimited ? 'text-blue-800' : 'text-red-800'}`}>{error}</p>
                      {showResendButton && (
                        <div className="mt-3">
                          <motion.button
                            ...
                            className="inline-flex items-center px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 border border-blue-300 rounded hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                          >
                            {isResending ? (
                              <>
