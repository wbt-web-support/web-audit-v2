...
export default function TechnologiesSection({ project }: TechnologiesSectionProps) {
  ...
  // Debug logging
  console.log('🔍 TechnologiesSection - Project technologies:', project.technologies)
  console.log('🔍 TechnologiesSection - Summary technologies:', project.scraping_data?.summary?.technologies)
  console.log('🔍 TechnologiesSection - Extracted technologies:', project.scraping_data?.extractedData?.technologies)
  console.log('🔍 TechnologiesSection - Final technologies:', technologies)
  console.log('🔍 TechnologiesSection - Is summary data:', isSummaryData)
      ...
      {technologies && technologies.length > 0 ? (
        <div className="space-y-6">
          ...
          {project.technologies_metadata?.technologies_by_category ? (
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-md font-medium text-gray-700">Detected Technical ({technologies.length})</h4>
                {isSummaryData && (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600">No technical detected</p>
        </div>
      )}
    </div>
  )
