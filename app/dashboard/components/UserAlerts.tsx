...
export default function UserAlerts({ userPlan = 'free' }: UserAlertsProps) {
  ...
  // Debug logging
  console.log('UserAlerts - Total alerts:', alerts.length)
  console.log('UserAlerts - Visible alerts:', visibleAlerts.length)
  console.log('UserAlerts - Dismissed alerts:', dismissedAlerts.size)
                ...
                <div className="flex-1">
                  ...
                  {alert.action_url && alert.action_text && (
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1 text-xs font-medium rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors"
                    >
                      {alert.action_text}
