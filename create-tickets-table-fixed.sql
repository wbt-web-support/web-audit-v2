-- Enhanced ticket system setup with proper RLS policies
-- This script creates the ticket system with proper permissions
...
--     'This is a sample ticket to test the system.',
--     'low'
-- );
...
DO $$
BEGIN
    RAISE NOTICE 'Ticket system setup completed successfully!';
