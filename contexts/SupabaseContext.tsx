...
interface SupabaseContextType {
  ...
  getUsers: () => Promise<{ data: any[] | null; error: any }>
  getUser: (userId: string) => Promise<{ data: any | null; error: any }>
  updateUser: (userId: string, updates: any) => Promise<{ data: any | null; error: any }>
  blockUser: (userId: string) => Promise<{ data: any | null; error: any }>
  unblockUser: (userId: string) => Promise<{ data: any | null; error: any }>
  changeUserRole: (userId: string, newRole: 'user' | 'admin') => Promise<{ data: any | null; error: any }>
...
export function SupabaseProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateTicket = async (id: string, updates: Partial<Ticket>) => {
    ...
    try {
      ...
      console.log('Update ticket response:', { data, error, hasData: !!data, hasError: !!error })
      ...
      console.log('Successfully updated ticket:', data?.id)
      return { data: data as Ticket, error: null }
    } catch (error) {
  ...
  const getUsers = async () => {
    ...
    try {
      ...
      console.log('Users response:', { data, error, hasData: !!data, hasError: !!error })
  ...
  const getUser = async (userId: string) => {
    ...
    try {
      ...
      console.log('User response:', { data, error, hasData: !!data, hasError: !!error })
  ...
  const updateUser = async (userId: string, updates: any) => {
    ...
    try {
      ...
      console.log('Update user response:', { data, error, hasData: !!data, hasError: !!error })
  ...
  const blockUser = async (userId: string) => {
    ...
    try {
      ...
      console.log('Block user response:', { data, error, hasData: !!data, hasError: !!error })
      ...
      console.log('Successfully blocked user:', data?.id)
      return { data: data as any, error: null }
    } catch (error) {
  ...
  const unblockUser = async (userId: string) => {
    ...
    try {
      ...
      console.log('Unblock user response:', { data, error, hasData: !!data, hasError: !!error })
      ...
      console.log('Successfully unblocked user:', data?.id)
      return { data: data as any, error: null }
    } catch (error) {
  ...
  const changeUserRole = async (userId: string, newRole: 'user' | 'admin') => {
    ...
    try {
      ...
      console.log('Change role response:', { data, error, hasData: !!data, hasError: !!error })
      ...
      console.log('Successfully changed user role:', data?.id)
      return { data: data as any, error: null }
    } catch (error) {
  ...
  const getUserActivity = async (userId: string) => {
    ...
    try {
      ...
      if (projectsError || ticketsError) {
        console.error('Error fetching user activity:', { projectsError, ticketsError })
        return { data: null, error: projectsError || ticketsError }
      }
      ...
      console.log('Successfully fetched user activity:', activity)
  ...
  const getUserProjects = async (userId: string) => {
    ...
    try {
      ...
      console.log('User projects response:', { data, error, hasData: !!data, hasError: !!error })
      ...
      console.log('Successfully fetched user projects:', data?.length || 0, 'projects')
      return { data: data as any[], error: null }
    } catch (error) {
  ...
  const getUserSubscription = async (userId: string) => {
    ...
    try {
      ...
      console.log('Successfully fetched user subscription:', mockSubscription)
